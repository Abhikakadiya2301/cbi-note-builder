...
// NEW: Format label for plaintext notes (Procura) – simple ASCII bold convention
function boldLabel(label) {
  return `${label}:`;
}

// NEW: Format label for HTML notes (Teams) – using <strong> tag
function boldLabelHTML(label) {
